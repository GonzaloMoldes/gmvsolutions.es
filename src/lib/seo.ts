...
const SEGMENT_LABELS: Record<string, string> = {
  ...
  oee: 'OEE y análisis Lean',
  seguridad: 'Seguridad y RGPD',
  ...
  'digitalizar-produccion-pyme-industrial': 'Cómo digitalizar la producción en una pyme industrial',
  'onboarding-digital-errores-manuales': 'Onboarding digital y reducción de errores manuales',
  'conocimiento-tacito-taller-industrial': 'Conocimiento tácito en el taller industrial',
  'documentar-procesos-mecanizado-cnc': 'Documentar procesos de mecanizado CNC',
